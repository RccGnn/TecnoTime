...
/**
 * Servlet implementation class configuratoreServlet2
 */
@WebServlet("/configuratoreServlet2")
public class configuratoreServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public configuratoreServlet2() {
        super();
